...
export const JourneySteps = ({ title = 'رحلتك في 4 خطوات', description = 'من التسجيل إلى الرخصة — بصرياً' }) => (
  <SectionBlock title={title} description={description} align="center">
    <div className="grid gap-comfortable sm:grid-cols-2 lg:grid-cols-4">
      {JOURNEY_STEPS.map((step, i) => (
        <div key={step.label} className="group relative overflow-hidden rounded-2xl shadow-card">
          <SafeImage
            src={step.image}
            alt={step.label}
